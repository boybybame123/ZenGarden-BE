...
{
    public class UserXpConfigService(IUserXpConfigRepository UserXpConfigRepository, IUnitOfWork unitOfWork, IMapper mapper) : IUserXpConfigService
    {
        ...
        public async Task UpdateUserXpConfigAsync(UserXpConfigDto UserXpConfig)
        {
            ...
            if(i.XpThreshold != null && i.XpThreshold >= 0)
            {
                i.XpThreshold = UserXpConfig.XpThreshold;
            }

...
namespace ZenGarden.Tests.Services
{
    public class PurchaseServiceTests
    {
        ...
        public async Task PurchaseItem_Successful_FirstTimePurchase_ReturnsSuccessMessage()
        {
            ...
            _mockNotificationService.Setup(n => n.PushNotificationAsync(userId, "Item", "Purchase successful.")).Returns(Task.CompletedTask);
            ...
            _mockNotificationService.Verify(n => n.PushNotificationAsync(userId, "Item", "Purchase successful."), Times.Once);
        }
        ...
        public async Task PurchaseItem_MonthlyPurchaseLimitReached_ReturnsErrorMessage()
        {
            ...
            _mockWalletRepo.Setup(r => r.GetByUserIdAsync(userId)).ReturnsAsync(wallet);
            _mockItemRepo.Setup(r => r.GetByIdAsync(itemId)).ReturnsAsync(item);
            _mockPurchaseHistoryRepo.Setup(r => r.CountPurchaseThisMonth(userId, itemId, startOfMonth)).ReturnsAsync(monthlyLimit);
        ...
        public async Task PurchaseItem_BagNotFound_ReturnsErrorMessage()
        {
            ...
            _mockPurchaseHistoryRepo.Verify(r => r.CreateAsync(It.IsAny<PurchaseHistory>()), Times.Once); // Purchase history has been created

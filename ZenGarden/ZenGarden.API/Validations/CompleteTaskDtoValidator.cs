...
public class CompleteTaskDtoValidator : AbstractValidator<CompleteTaskDto>
    {
        private static readonly string[] AllowedFileExtensions = { ".jpg", ".jpeg", ".png", ".pdf", ".doc", ".docx", ".txt", ".zip" };
        ...
        public CompleteTaskDtoValidator()
        {
            ...
            When(dto => dto.TaskFile != null, () =>
            {
                RuleFor(dto => dto.TaskFile)
                    .Must(BeAValidFile).WithMessage($"Invalid file. Allowed extensions: {string.Join(", ", AllowedFileExtensions)}. Maximum size: 10MB.");
            });

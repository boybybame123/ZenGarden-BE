...
public class PurchaseHistoriesController : Controller
{
    ...
    public async Task<IActionResult> Create(
        [Bind("PurchaseId,UserId,ItemId,TotalPrice,CreatedAt,UpdatedAt,Status")]
    ...
    public async Task<IActionResult> Edit(int id,
        ...
        PurchaseHistory purchaseHistory)
    {
        if (id != purchaseHistory.PurchaseId) return NotFound();
        ...
        if (ModelState.IsValid)
        {
            ...
            {
                if (!PurchaseHistoryExists(purchaseHistory.PurchaseId)) return NotFound();
    ...
    {
        var purchaseHistory = await _context.PurchaseHistory.FindAsync(id);
        if (purchaseHistory != null) _context.PurchaseHistory.Remove(purchaseHistory);

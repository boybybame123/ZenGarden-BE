...
public class TreeXpLogRepository(ZenGardenContext context, IRedisService redisService)
    : GenericRepository<TreeXpLog>(context, redisService), ITreeXpLogRepository
{

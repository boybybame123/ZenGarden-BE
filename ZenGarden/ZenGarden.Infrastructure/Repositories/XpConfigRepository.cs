...
public class XpConfigRepository(ZenGardenContext context, IRedisService redisService) : GenericRepository<XpConfig>(context, redisService), IXpConfigRepository
{
